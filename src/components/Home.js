          ...
          <Col className="my-auto">
            <Row className="p-3 p-md-5">
              <Col xs="10">
                ...
                <br />
                <p>
                  Je suis <span className="text-yellow">Olivier Chabot</span>.
            ...
            <Row className="justify-content-center p-3 p-md-5">
              <Col>
                <Typelighter />
              </Col>
            </Row>
            <Row className="justify-content-center justify-content-md-end align-content-md-start p-md-5">
              <Col xs="auto">
                <Link
                  className="nav-link"
